...
with_node \
  ...
  --target "/Users/durgaprasad/dev/myprojects/audio_assist/voice-notes-ai/ios/Pods/Target Support Files/Pods-NoteOnGoAI/ExpoModulesProvider.swift" \
  --entitlement "/Users/durgaprasad/dev/myprojects/audio_assist/voice-notes-ai/ios/NoteOnGoAI/NoteOnGoAI.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-router" "expo-speech-recognition" "expo-splash-screen" "expo-sqlite"
